...
class Application(Base):
    ...
    # Una aplicación por email (case-insensitive). Respaldo a nivel BD del
    # chequeo idempotente en services.create_application.
    __table_args__ = (
        Index(
            "uq_applications_email_lower",
            text("lower(applicant_email)"),
            unique=True,
        ),
    )
