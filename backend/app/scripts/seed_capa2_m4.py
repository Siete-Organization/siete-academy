"""Seed: Prueba del Módulo 4 — Capa 2.
...
Asume que el Módulo 4 ya existe en DB (creado por seed_w7.py). Idempotente.

Uso:
    cd backend && .venv/bin/python -m app.scripts.seed_capa2_m4
"""
...
configure_logging()
log = get_logger("seed_capa2_m4")

MODULE_SLUG = "m4-el-sistema"
ASSESSMENT_TITLE = "Prueba del Módulo 4 (Capa 2)"
