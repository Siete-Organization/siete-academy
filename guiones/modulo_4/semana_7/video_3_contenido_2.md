# Video 21 · Módulo 4 · Semana 7 · Video 3 — Contenido 2

**Título:** Orden, variantes, entregabilidad y herramientas (Bloques 5-8)
...
## BLOQUE 5 — La lógica del orden: correo → llamada → WhatsApp  —  🎙️ VOZ EN OFF (slide en pantalla) · ~1:30

> 🖼️ **EN PANTALLA — SLIDE:** Por qué el correo va primero
...
> 🖼️ **EN PANTALLA — SLIDE:** Por qué la llamada va después

Tres razones. **Amplifica el correo:** llega con contexto —"te escribí la semana pasada"— y deja de ser una interrupción al azar. **Resuelve en tiempo real** objeciones o dudas que el correo no habría resuelto. Y **obliga a decidir:** el correo puede quedar "para después"; la llamada pide respuesta ahora.

> 🖼️ **EN PANTALLA — SLIDE:** Por qué WhatsApp es empujón, no entrada

Tres razones, todas críticas. **Se percibe como espacio personal:** meterse ahí sin contacto previo se siente invasivo. **El riesgo de bloqueo es alto** si parece spam o masivo, y un bloqueo es definitivo. Y **funciona mejor con contexto previo:** "te escribí hace unos días sobre tal cosa" más WhatsApp es aceptable; WhatsApp en frío, sin historia, es bloqueo.

> 🖼️ **EN PANTALLA — SLIDE:** El orden estándar en LATAM B2B

Toques uno y dos, correo. Toque tres, llamada —después de dos correos—. Toques cuatro y cinco, correos con ángulos nuevos. Toque seis, WhatsApp si hay número verificado —empujón—. Toque siete, última llamada. LinkedIn corre en paralelo: conectar e investigar al mismo tiempo que la secuencia principal, **sin contar como toque de la cadencia**.

## BLOQUE 6 — Las 6 variantes de acceso al decisor  —  🎙️ VOZ EN OFF (slide en pantalla) · ~2:15

> 🖼️ **EN PANTALLA — SLIDE:** El bloque más importante del módulo
...
> 🖼️ **EN PANTALLA — SLIDE:** Las 5 variantes según tu contacto del decisor
...
> 🖼️ **EN PANTALLA — SLIDE:** La excepción — la cuenta de altísimo valor
...
> 🖼️ **EN PANTALLA — SLIDE:** Cómo diagnosticar la variante
...
> 🖼️ **EN PANTALLA — SLIDE:** El criterio se queda
...
## BLOQUE 7 — La entregabilidad como concepto fundamental  —  🎙️ VOZ EN OFF (slide en pantalla) · ~1:30

> 🖼️ **EN PANTALLA — SLIDE:** Por qué te importa aunque no la configures
...
> 🖼️ **EN PANTALLA — SLIDE:** Los 4 factores

**Reputación del dominio.** El "@" de tu correo tiene una reputación que los proveedores —Google, Microsoft— llevan por dentro. Un dominio nuevo arranca con reputación baja. Se gana con tiempo, volumen razonable y respuestas reales; se pierde con quejas de spam, rebotes altos y envíos masivos.
...
> 🖼️ **EN PANTALLA — SLIDE:** Qué es una casilla quemada
...
> 🖼️ **EN PANTALLA — SLIDE:** Cómo el SDR rompe la entregabilidad sin saberlo
...
## BLOQUE 8 — Las herramientas como instrumentación del concepto  —  🎙️ VOZ EN OFF (slide en pantalla) · ~1:30

> 🖼️ **EN PANTALLA — SLIDE:** Concepto vs herramienta
...
> 🖼️ **EN PANTALLA — SLIDE:** Los ejemplos
...
> 🖼️ **EN PANTALLA — SLIDE:** La pregunta para el resto de tu carrera
...
## EJERCICIO EN VIVO — Caso de variantes  —  🎥 A CÁMARA · ~1:30

Vamos con un caso para que diagnostiques la variante.

> 🖼️ **EN PANTALLA — SLIDE:** Caso — recontacto con señal nueva
...
## SÍNTESIS DE LA SEMANA  —  🎥 A CÁMARA · ~50s

> 🖼️ **EN PANTALLA — SLIDE:** 7 ideas de la Semana 7
...
## PUENTE A SEMANA 8  —  🎥 A CÁMARA · ~25s
