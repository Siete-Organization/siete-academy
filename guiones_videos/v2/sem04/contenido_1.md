---
video: Sem 4 — Contenido 1
modulo: 2 — El otro lado
semana: 4 — Entender al comprador
titulo: ICP, buyer persona y la psicología del decisor (Bloques 1-3)
duracion_estimada: ~8:30
palabras_aprox: 1300
ejercicio: si — Caso Mauro y Ramiro (Bloque 2)
fuente_doc: SDR_Academy_Siete_Documento_Maestro.md, líneas 5852-6018
formato: contenido_semanal_v2 (split 1 de 2)
bloques_cubiertos: 1, 2, 3
concepto_pilar_destacado: Quién impulsa la decisión vs quién solo conversa — una minoría mueve el comité
ejercicio_seleccionado: Caso Mauro (el escéptico) y Ramiro (el que divulga)
---

# Sem 4 — Contenido 1 — ICP, buyer persona y la psicología del decisor (Bloques 1-3)
...
## [BLOQUE 1 — ICP vs buyer persona: dos filtros distintos ~1:50]

**[SLIDE: La distinción central]**
...
**[SLIDE: Buyer persona — qué incluir]**
...
## [BLOQUE 2 — Cómo se mueve un comité por dentro ~2:30]

**[SLIDE: Los que impulsan — los que mueven la decisión]**
...
**[SLIDE: Los que solo conversan — hablan pero no mueven]**
...
**[SLIDE: La idea central — solo una minoría mueve]**
...
## [EJERCICIO EN VIVO — Caso Mauro y Ramiro ~1:30]

Vamos a aplicar estos perfiles de conducta en dos casos reales.

**[SLIDE: Contacto A — Mauro, Director de Operaciones]**
...
**[SLIDE: Contacto B — Ramiro, Gerente General]**
...
a) El que busca beneficio propio.
b) El que divulga.
c) El que negocia información.
d) El amistoso.
...
## [BLOQUE 3 — Psicología del decisor B2B ~2:00]

**[SLIDE: 4 motores + 3 frenos]**
...
**[SLIDE: Pensamiento rápido vs pensamiento deliberado]**
