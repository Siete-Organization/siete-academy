---
video: Sem 8 — Contenido 2
modulo: 4 — El sistema
semana: 8 — Del proceso al mindset de mejora continua
titulo: Métricas, diagnóstico, mejora continua y cierre del curso (Bloques 5-8)
duracion_estimada: ~8:30
palabras_aprox: 1380
ejercicio: si — Tabla de Juan (Bloque 6) + De señal a hipótesis (Bloque 7)
fuente_doc: LIMPIO_S8.md (guiones_corregidos_NICO), Bloques 5-8 + síntesis del curso
formato: contenido_semanal_v2 (split 2 de 2)
bloques_cubiertos: 5, 6, 7, 8
concepto_pilar_destacado: Aguas abajo es síntoma, aguas arriba es causa — diagnóstico por descarte
ejercicio_seleccionado: Tabla de Juan — caída de tasa de respuesta con el resto estable
cierre_curso: si
---

# Sem 8 — Contenido 2 — Métricas, diagnóstico, mejora y cierre del curso (Bloques 5-8)
...
## [BLOQUE 5 — El embudo de métricas ~2:00]

**[SLIDE: Una métrica por tramo]**
...
**[SLIDE: Aguas abajo es síntoma. Aguas arriba es causa.]**
...
**[SLIDE: La métrica que el SDR moderno ya NO mide]**
...
## [BLOQUE 6 — Diagnóstico por descarte ~1:15]
...
## [EJERCICIO EN VIVO — Tabla de Juan ~2:15]

Vamos con un caso. Es la mejor prueba del curso. Lee con calma.

**[SLIDE: Las métricas de Juan, 4 semanas]**
...
## [BLOQUE 7 — Mindset de mejora continua ~1:30]

**[SLIDE: Plan, Do, Check, Act]**
...
**[SLIDE: Una variable por experimento]**
...
## [EJERCICIO EN VIVO — De señal a hipótesis ~1:00]

**[SLIDE: Caso — 3 respuestas parecidas]**

Esta semana, tres prospectos respondieron con variantes de lo mismo: *"Interesante, pero justo estamos con un rediseño organizacional y todo lo nuevo está pausado hasta el tercer trimestre."*

¿Qué hipótesis formulas, y cómo la testeas?
...
## [BLOQUE 8 — Los 5 atributos del SDR que perdura ~1:15]

**[SLIDE: Los 5 atributos]**
...
## [SÍNTESIS DEL CURSO ~50s]

**[SLIDE: Los 4 módulos en un mapa]**
...
## [CIERRE DEL CURSO ~45s]

**[SLIDE: La frase final]**
...
## [PUENTE A LA GUÍA Y AL DESPUÉS ~25s]
...
**Fuentes de este video** (para sección de Bibliografía en plataforma, no se narra):
- Deming, W. E. (1982). *Out of the Crisis*. MIT Press. (Ciclo Plan-Do-Check-Act.)
- Ries, E. (2011). *The Lean Startup*. Crown Business. (Construir-medir-aprender.)
- Apple (2021). *Mail Privacy Protection* (documentación oficial).
