...
titulo: Del proceso al mindset — qué te llevas esta última semana
duracion_estimada: ~3:00
palabras_aprox: 440
ejercicio: no
fuente_doc: LIMPIO_S8.md (guiones_corregidos_NICO), Pregunta central + objetivos
formato: intro_semanal_v2
---

# Sem 8 — Intro — Del proceso al mindset de mejora continua
...
## [PUENTE DESDE SEM 7 / PREGUNTA CENTRAL ~25s]
...
La pregunta central de esta semana es justamente esa, traducida a operación diaria:

**¿Cómo se ejecuta esto todos los días, y cómo sabes si está funcionando?**
...
## [QUÉ VAS A PODER HACER ~60s]

**[SLIDE: Objetivos de la Semana 8]**
...
## [CÓMO USAR EL MATERIAL / LO QUE PASA ESTA SEMANA ~20s]

**[SLIDE: Cómo estudiar esta semana]**
