---
video: Sem 1 — Contenido 1
modulo: 1 — El juego y el jugador
semana: 1 — Anatomía de la venta B2B
titulo: Cómo se decide una compra B2B (Bloques 1-3)
duracion_estimada: ~8:00
palabras_aprox: 1180
ejercicio: si — Caso Julia (Bloque 2)
fuente_doc: SDR_Academy_Siete_Documento_Maestro.md, líneas 2543-2736
formato: contenido_semanal_v2 (split 1 de 2)
bloques_cubiertos: 1, 2, 3
concepto_pilar_destacado: Paradoja del comprador B2B + dinámica del comité (Bloque 2)
ejercicio_seleccionado: Caso Julia — política interna invisible
---

# Sem 1 — Contenido 1 — Cómo se decide una compra B2B (Bloques 1-3)
...
## [BLOQUE 1 — Las 5 diferencias estructurales ~1:30]

**[SLIDE: B2C vs B2B en 5 ejes]**
...
## [BLOQUE 2 — La paradoja del comprador y la dinámica del comité ~2:00]

**[SLIDE: La paradoja del comprador B2B]**
...
**[SLIDE: Las 5 capas invisibles detrás de cada decisión]**
...
**[SLIDE: Nadie decide solo — basta con que nadie se oponga]**
...
## [BLOQUE 3 — Las 5 etapas del buying cycle ~1:30]
...
## [EJERCICIO EN VIVO — Caso Julia ~1:45]

Vamos con un caso para que apliques lo aprendido.

**[SLIDE: Caso — Julia, Gerenta de Marketing]**
...
- Gartner (2020-2023). *The B2B Buying Journey Report*.
- Kahneman, D. (2011). *Thinking, Fast and Slow*. Farrar, Straus and Giroux.
- Dixon, Adamson, Toman & Spenner (2015). *The Challenger Customer*. Portfolio/Penguin.
