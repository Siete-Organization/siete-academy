---
video: Sem 1 — Contenido 2
modulo: 1 — El juego y el jugador
semana: 1 — Anatomía de la venta B2B
titulo: Quiénes deciden y dónde encajas tú (Bloques 4-6)
duracion_estimada: ~8:00
palabras_aprox: 1200
ejercicio: si — Perfil Ana (Bloque 4)
fuente_doc: SDR_Academy_Siete_Documento_Maestro.md, líneas 2738-2987
formato: contenido_semanal_v2 (split 2 de 2)
bloques_cubiertos: 4, 5, 6
concepto_pilar_destacado: Cada rol tiene motivación y miedo distintos — el mensaje habla a los suyos
ejercicio_seleccionado: Perfil Ana — coach + referidor (oro para SDR)
---

# Sem 1 — Contenido 2 — Quiénes deciden y dónde encajas tú (Bloques 4-6)
...
## [BLOQUE 4 — Los 9 roles del comité ~2:00]

**[SLIDE: Los 4 roles clásicos del comité]**
...
## [BLOQUE 5 — El ciclo de vida del prospecto ~1:30]

**[SLIDE: Cambio de mirada — el lado del que vende]**
...
## [BLOQUE 6 — Quién paga, quién aprueba, quién usa ~1:30]

**[SLIDE: Qué es una LOB]**
...
## [EJERCICIO EN VIVO — Perfil Ana ~1:45]

Vamos con un caso para que apliques los roles del comité.

**[SLIDE: Empresa de 250 empleados, software de cadena de suministro]**
...
- Bridge Group (2022). *SDR Metrics & Compensation Report*.
- Gartner (2020-2023). *The B2B Buying Journey Report*. Roles y dinámica de comité.
